...
public record HistorialResponseDto(
        ...
        List<EyeExamDetailDto> eyeExams
) {
    public record PersonalBackgroundDto(String personalHistory, String familyHistory, String ocularHistory, String surgicalHistory, String medications, String allergies, String observations) {}
