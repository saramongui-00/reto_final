...
public class ApplicationServiceBeanConfig {
    ...
    @Bean
    public CreateHistorialUseCase createHistorialUseCase(HistorialRepository repository,
                                                         CitaEnEsperaPort citaEnEsperaPort,
                                                         EventPublisher eventPublisher) {
        return new CreateHistorialUseCaseImpl(repository, citaEnEsperaPort, eventPublisher);
    }
